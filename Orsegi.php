...
<head>
	...
	<link rel="stylesheet" href="asset/css/gombstyle.css">
	...
	<title>VáltozóJövő - Őrségi Nemzeti Park</title>
							...
							<ul>
								...
								<li class="dropdown active"><a href="Területek.php">Területek</a>
									<div class="dropdown-content">
										...
										<a class="active1">Őrségi Nemzeti Park</a>
									</div>
...
<!--NAVIGÁCIÓ-->
	...
	<div class="col-xl-6 keret">
		<h2 class="fst-italic py-3 px-3 text-white" style="border:2px solid black; background-color: purple">Őrségi Nemzeti Park</h2>
			
		<!--SOR 1-->
			<div class="row wow fadeInUp" data-wow-delay="0.2s">
				<div class="col-md-6 lightbox-trigger">
					<img class="img-fluid thumbnail leftimage my-4" src="asset/img/orseg2.jpg">
				</div>
		...
		<div class="row wow fadeInUp" data-wow-delay="0.3s">
			<div class="col-md-6">
				<h6>Az Őrségi Nemzeti Parkot 2002-ben alapították, és Őriszentpétert választották székhelyül. A térség magába foglalja az Őrség, Rába folyó völgye, Vendvidék és a Szentgyörgyvölgy környékét is. </h6>
				<h6>A park egy széles dombságon terül el, amin több mint 200 forrás és 15 patak található. A parkon belül több mint 13 tanösvény közül választhatsz, melyeknek mind megvan a maga különlegessége. Ezek közül hármat szeretnénk kiemelni, amik szerintünk kihagyhatatlanok:</h6>
			</div>
			
			<div class="col-md-6 lightbox-trigger">
				<img class="img-fluid thumbnail rightimage" src="asset/img/orseg.jpg">
			</div>
			<hr class="my-4">
		</div>
		<!--SOR 2-->
		...
		<!--SOR 3-->
			<div class="row wow fadeInUp" data-wow-delay="0.4s">
				<div class="col-md-6 lightbox-trigger">
					<img class="img-fluid thumbnail leftimage" src="asset/img/tanosveny1.jpg">
				</div>

				<div class="col-md-6 my-3">
					<h4>Ság hegyi geológiai és természetismereti tanösvény</h4>
					<h6>A Ság-hegyen ez a két tanösvény található, melyek együttesen alig tesznek ki 600 métert. A bazaltbányához vezető úton információs táblák mesélnek a hely történelméről és kialakulásáról. Továbbá az Eötvös Loránd turistaház mellett a terület növény-és állatvilágáról is olvashatunk.</h6>
				</div>
				<hr class="my-4">
			</div>
		<!--SOR 3-->
		...
		<!--SOR 4-->
			<div class="row wow fadeInUp" data-wow-delay="0.5s">
				<div class="col-md-6">
					<h4>Óriások Útja tanösvény</h4>
					<h6>Ez a tanösvény a Széles-kő és a Kalapos kő hegyvonulatai között terül el. Találkozhatsz misztikus barlangokkal, érdekes sziklaalakzatokkal és kőfülkékkel is, melyek a Sibrik-vártól a Kalapos kőig tarkítják az utat.</h6>
					<h6>Az ösvény jól bemutatja a Kőszegi-hegység növényvilágát és a park madárismereti és madárvédelmi céljait. A túra nagyjából 2 kilométer hosszúságú, így bőven jut majd energia és idő, hogy egy másik tanösvényt is felderíts.</h6>
				</div>
		...
		<!--SOR 5-->
			<div class="row wow fadeInUp" data-wow-delay="0.6s">
				<div class="col-md-6 lightbox-trigger">
					<img class="img-fluid thumbnail leftimage" src="asset/img/tanosveny3.jpg">
				</div>

				<div class="col-md-6 my-3">
					<h4>Sárgaliliom tanösvény</h4>
					<h6>A Sárgaliliom tanösvény az Őrségben található, és közel 6,2 km hosszú. A terület kulturális és természeti értékeit nagyon jó bemutatja, az út Velemértől Magyarszombatfáig vezet.</h6>
				</div>
				<hr class="my-4">
			</div>
		<!--SOR 5-->
				...
				<div class="container-fluid">
					<div class="row justify-content-center align-items-center">
					  <div class="col-12">
						...
						<h4 class="text-center">Szaknyér Ifjúsági Tábor</h4>
						<img src="asset/img/Orsegimap.png" alt="Orsegimap" class="img-fluid keret">
					  </div>
					</div>
						<div class="col-md-12">
					...
					<div class="keret">
						...
						<div class="row wow fadeInUp" data-wow-delay="0.4s">
							...
							<h4 class="fst-italic py-3 px-3 text-white text-center" style="border:2px solid black; background-color: purple">Jelenlegi adatok</h4>
									<button id="showTable1Btn" onclick="showTable(1)" class="my-button">Állatok</button>
									<button id="hideTable1Btn" onclick="hideTable(1)" class="my-button" style="display: none;">Bezár</button>
									<button id="showTable2Btn" onclick="showTable(2)" class="my-button">Növények</button>		
									<button id="hideTable2Btn" onclick="hideTable(2)" class="my-button" style="display: none;">Bezár</button>
								</div>
							</div>
						</div>
					</div>
