...
<head>
	...
	<title>VáltozóJövő - Aggteleki Nemzeti Park</title>
...
<!--NAVIGÁCIÓ-->
	 <section id="referenciak" class="wow fadeInUp" data-wow-delay="0.1s">
		<div class="container-fluid clearfix">
			<div class="row">
				<div class="col-xl-3">
					<div class="keret position-sticky" style="top: 6rem;">
							...
							<ul>
								...
								<li class="dropdown active"><a href="Területek.php">Területek</a>
									<div class="dropdown-content">
										<a class="active1">Aggteleki Nemzeti Park</a>
		...
		<div class="col-xl-6 keret">
			<h2 class="fst-italic py-3 px-3 text-white" style="border:2px solid black; background-color: purple">Aggteleki Nemzeti Park</h2>
				
			<!--SOR 1-->
				<div class="row wow fadeInUp" data-wow-delay="0.2s">
					<div class="col-md-6 lightbox-trigger">
						<img class="img-fluid thumbnail leftimage my-4" src="asset/img/aggtelek1.jpg">
					</div>
			...
			<!--SOR 2-->
				<div class="row wow fadeInUp" data-wow-delay="0.3s">
					<div class="col-md-6">
						<h6>Az Aggteleki Nemzeti Park volt az első, melyet a geológiai képződmények védelmére hoztak létre. Alacsonyhegységi-dombsági szinten helyezkedik el, több mint 20 ezer hektáron. Az itt található mészkő 210-240 millió évvel ezelőtt rakódott le, a karsztjelenségek az ezt követő időszakban alakultak ki. </h6>
					</div>
					
					<div class="col-md-6 lightbox-trigger">
						<img class="img-fluid thumbnail rightimage" src="asset/img/aggtelek2.jpg">
					</div>
					<hr class="my-4">
				</div>
			<!--SOR 2-->
			...
			<!--SOR 3-->
				<div class="row wow fadeInUp" data-wow-delay="0.4s">
					<div class="col-md-6 lightbox-trigger">
						<img class="img-fluid thumbnail leftimage" src="asset/img/aggtelek3.jpg">
					</div>

					<div class="col-md-6 my-4">
						<h6>A cseppkőbarlangok és karsztjelenségek ma már az UNESCO Világörökség részeit képezik.</h6>
						<h6>Az Aggteleki-karszton 90 forrás tör felszínre, legnagyobb hozamú vízfolyása a Jósva-patak. Részben emiatt lett Jósvafő a nemzeti park székhelye 1985-ben. A parkon belül 273 karsztjelenség található, amiből 25 fokozottan védett. </h6>
					</div>
					<hr class="my-4">
				</div>
			<!--SOR 3-->
			...
			<!--SOR 4-->
				<div class="row wow fadeInUp" data-wow-delay="0.5s">
					<div class="col-md-6">
						<h6>Lefelé táguló aknaszerű mélyedések, úgynevezett zsombolyok találhatóak a barlangokban és több barlang is rendelkezik szerteágazó aktív patakrendszerrel. A cseppkövek a mészkő és más karbonátok egyedi kiválásának képződményei, melyeknek több fajtája is változatossá teszi a karsztot. Megfigyelhetőek álló és fekvő cseppkövek, cseppkőoszlopok, mésztufagátak, aragonitbokrok, heliktitek és cseppkőzászlók is.</h6>
					</div>

					<div class="col-md-6 lightbox-trigger">
						<img class="img-fluid thumbnail rightimage" src="asset/img/aggtelek4.jpg">
					</div>
					<hr class="my-4">
				</div>
			<!--SOR 4-->
			...
			<!--SOR 5-->
				<div class="row wow fadeInUp" data-wow-delay="0.6s">
					<div class="col-md-6 lightbox-trigger">
						<img class="img-fluid thumbnail leftimage" src="asset/img/aggtelek5.jpg">
					</div>

					<div class="col-md-6 my-4">
						<h6>A nemzeti parkot 2 barlangrendszer alkotja, melyek Szlovákiába is átnyúlnak. Az egyik a Szilicei jégbarlang, ami a világon a legalacsonyabban fekvő jégbarlang, míg a másik a Baradia-Domica barlangrendszer, ami 25 kilométeren húzódik.</h6>
					</div>
					<hr class="my-4">
				</div>
			<!--SOR 5-->
				...
				<div class="container-fluid">
					<div class="row justify-content-center align-items-center">
						<div class="col-12">
							...
							<h4 class="text-center"><b>Szalamandra Erdei Iskola</b></h4>
							<img class="img-fluid keret" src="asset/img/Aggtelekmap.png" alt="Aggtelekmap">
							</div>
						</div>
							<div class="col-md-12">
					...
					<div class="keret">
						...
						<div class="row wow fadeInUp" data-wow-delay="0.4s">
							...
							<h4 class="fst-italic py-3 px-3 text-white text-center" style="border:2px solid black; background-color: purple">Jelenlegi adatok</h4>
										<button id="showTable5Btn" onclick="showTable(5)" class="my-button">Állatok</button>
										<button id="hideTable5Btn" onclick="hideTable(5)" class="my-button" style="display: none;">Bezár</button>
										<button id="showTable6Btn" onclick="showTable(6)" class="my-button">Növények</button>		
										<button id="hideTable6Btn" onclick="hideTable(6)" class="my-button" style="display: none;">Bezár</button>
								</div>
							</div>
						</div>
					</div>
