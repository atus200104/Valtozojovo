...
<head>
	...
	<title>VáltozóJövő - Balaton-felvidéki Nemzeti Park</title>
...
<!--NAVIGÁCIÓ-->
							...
							<ul>
								...
								<li class="dropdown active"><a href="Területek.php">Területek</a>
									<div class="dropdown-content">
										...
										<a class="active1" style="margin-bottom: 1.5px;">Balaton-felvidéki Nemzeti Park</a>
	...
	<div class="col-xl-6 keret">
		<h2 class="fst-italic py-3 px-3 text-white" style="border:2px solid black; background-color: purple">Balaton-felvidéki Nemzeti Park</h2>
			
		<!--SOR 1-->
			<div class="row wow fadeInUp" data-wow-delay="0.2s">
				<div class="col-md-6 lightbox-trigger">
					<img class="img-fluid thumbnail leftimage" style="margin-top: 30px;" src="asset/img/balaton1.jpg">
				</div>
				<div class="col-md-6">
		...
		<!--SOR 2-->
			<div class="row wow fadeInUp" data-wow-delay="0.3s">
				<div class="col-md-6">
					<h6>A Balaton-felvidéki Nemzeti Parkhoz tartozik a Dél-Bakony, a Tapolcai-medence, a Kis-Balaton medencéje és a Keszthelyi fennsík. Székhelye Csopakon található, amit 1997-ben hoztak létre az 57 ezer hektáros terület igazgatására. </h6>
				</div>

				<div class="col-md-6 lightbox-trigger">
					<img class="img-fluid thumbnail rightimage" src="asset/img/balaton2.jpg">
				</div>
				<hr class="my-4">
			</div>
		<!--SOR 2-->
		...
		<!--SOR 3-->
			<div class="row wow fadeInUp" data-wow-delay="0.4s">
				<div class="col-md-6 lightbox-trigger">
					<img class="img-fluid thumbnail leftimage" src="asset/img/balaton3.jpg">
				</div>

				<div class="col-md-6 my-4">
					<h6>Természetvédelmi területek sora övezi, a térségben közel 25 ökoszisztéma viselheti büszkén ezt a címet. A park talán leghíresebb része a rég óta védett Tihanyi-félsziget. A terület kialakulását az egykor aktív vulkáni működés tette jellegzetessé.</h6>
				</div>
				<hr class="my-4">
			</div>
		<!--SOR 3-->
		...
		<!--SOR 4-->
			<div class="row wow fadeInUp" data-wow-delay="0.5s">
				<div class="col-md-6">
					<h6>A hévforrások működésének nyomai még mindig megtalálhatóak az úgynevezett gejzírkúp képződmények formájában. A félszigettől észak-nyugatra fekvő Pécselyi-medence, a hagyományos gazdálkodási módokról híres, többek között a borászatáról is. </h6>
				</div>

				<div class="col-md-6 lightbox-trigger">
					<img class="img-fluid thumbnail rightimage" src="asset/img/balaton4.jpg">
				</div>
				<hr class="my-4">
			</div>
		<!--SOR 4-->
		...
		<!--SOR 5-->
			<div class="row wow fadeInUp" data-wow-delay="0.6s">
				<div class="col-md-6 lightbox-trigger">
					<img class="img-fluid thumbnail leftimage" style="margin-top: 50px;" src="asset/img/balaton5.jpg">
				</div>

				<div class="col-md-6 my-4">
					<h6>A terület flóra és faunája igen változatos, a medence élőhelyül szolgál többek között a gyurgyalagnak, a bíboros kosbornak, nagyezerjófűnek és a pettyes gőtének is. A Tapolcai-medencében található a Szent-György hegy, ahol szintén jól megfigyelhetőek a vulkáni nyomok; bazalttufák, bazaltzsákok és bazaltkúpok veszik körbe a kőtengert, ami miatt tanúhegynek is nevezik.</h6>
					<h6>Kis-Balaton madárvilága páratlan Magyarországon, amiért 1986 óta Tájvédelmi Körzetként funkcionál. A Keszthelyi fennsík főként dolomitból épül fel, amit a szurdokvölgyek és barlangok tesznek igazán látványossá.</h6>
				</div>
				<hr class="my-4">
			</div>
		<!--SOR 5-->
				...
				<div class="container-fluid">
					<div class="row justify-content-center align-items-center">
					  <div class="col-12">
						...
						<h4 class="text-center"><b>Zánkai Erzsébet-tábor</b></h4>
						<img src="asset/img/Balatonfelvmap.png" alt="Balatonfelvmap" class="img-fluid keret">
					  </div>
					</div>
						<div class="col-md-12">
					...
					<div class="keret">
						...
						<div class="row wow fadeInUp" data-wow-delay="0.4s">
							...
							<h4 class="fst-italic py-3 px-3 text-white text-center" style="border:2px solid black; background-color: purple">Jelenlegi adatok</h4>
									<button id="showTable3Btn" onclick="showTable(3)" class="my-button">Állatok</button>
									<button id="hideTable3Btn" onclick="hideTable(3)" class="my-button" style="display: none;">Bezár</button>
									<button id="showTable4Btn" onclick="showTable(4)" class="my-button">Növények</button>		
									<button id="hideTable4Btn" onclick="hideTable(4)" class="my-button" style="display: none;">Bezár</button>
								</div>
							</div>
						</div>
					</div>
