...
<head>
	...
	<title>VáltozóJövő - Táborok</title>
					...
					<div class="keret position-sticky">
						...
						<div class="oldalnav">
							<ul>
								...
								<li class="dropdown active">Területek
...
<!--NAVIGÁCIÓ-->
	...
	<div class="col-xl-6 keret">
		<h2 class="fst-italic py-3 px-3 text-white" style="border:2px solid black; background-color: purple">Nemzeti Parkjaink</h2>
			
		<!--SOR 1-->
			<div class="row wow fadeInUp" data-wow-delay="0.2s">
				<div class="col-md-1 mt-2 lightbox-trigger">
					<img src="asset/img/aggteleki-logo-57x48-e1394573623114.png">
				</div>

				<div class="col-md-11 mt-2">
					<h5>Aggteteli Nemzeti Park</h5>
					<p>Az Aggteleki Nemzeti Park volt az első, melyet a geológiai képződmények védelmére hoztak létre. Alacsonyhegységi-dombsági szinten helyezkedik el, több mint 20 ezer hektáron.</p>
					<a class="continue" href="Aggtelek.php">Tovább az oldalra<p class="arrowselect right"></p></a>
				</div>
			</div>
		<!--SOR 1-->
		...
		<!--SOR 2-->
			...
			<div class="row wow fadeInUp" data-wow-delay="0.2s">
				<div class="col-md-1 mt-2 lightbox-trigger">
					<img src="asset/img/logo-balaton-felvidek-e1394573687333-1.png">
				</div>

				<div class="col-md-11 mt-2">
					<h5>Balaton-felvidéki Nemzeti Park</h5>
					<p>A Balaton-felvidéki Nemzeti Parkhoz tartozik a Dél-Bakony, a Tapolcai-medence, a Kis-Balaton medencéje és a Keszthelyi fennsík. Székhelye Csopakon található, amit 1997-ben hoztak létre az 57 ezer hektáros terület igazgatására.</p>
					<a class="continue" href="Balatonfelv.php">Tovább az oldalra<p class="arrowselect right"></p></a>
				</div>
			</div>
		<!--SOR 2-->
		...
		<!--SOR 3-->
			...
			<div class="row wow fadeInUp" data-wow-delay="0.2s">
				<div class="col-md-1 mt-2 lightbox-trigger">
					<img src="asset/img/logo-bukk-e1394574400422.png">
				</div>

				<div class="col-md-11 mt-2">
					<h5>Bükki Nemzeti Park</h5>
					<p>Az egyik legnépszerűbb látnivaló a park erdői között zakatoló erdei vasút. A park hegy csúcsain még megtalálhatóak olyan vármaradványok, amiket az idő vasfoga epuszíttott már. Azonban Diósgyőri vár és Hollókői vár tökéletes állapotban vannak és hazánk legfontosabb műemlékei közé tartoznak</p>
					<a class="continue" href="Bukki.php">Tovább az oldalra<p class="arrowselect right"></p></a>
				</div>
			</div>
		<!--SOR 3-->
		...
		<!--SOR 4-->
			...
			<div class="row wow fadeInUp" data-wow-delay="0.2s">
				<div class="col-md-1 mt-2 lightbox-trigger">
					<img src="asset/img/logo-duna-drava-e1394573725311.png">
				</div>

				<div class="col-md-11 mt-2">
					<h5>Duna-Dráva Nemzeti Park</h5>
					<p>A pécsi székhellyel rendelkező nemzeti park az országhatár, a Sió-torkolat és a Dráva mentén helyezkedik el, több mint 50 ezer hektárt fed le. Legnagyobb része dombság és síkság, egyedül a Mecsek és a Villányi-hegység emelkednek ki a domborzaton.</p>
					<a class="continue" href="DunaDrava.php">Tovább az oldalra<p class="arrowselect right"></p></a>
				</div>
			</div>
		<!--SOR 4-->
		...
		<!--SOR 5-->
			...
			<div class="row wow fadeInUp" data-wow-delay="0.2s">
				<div class="col-md-1 mt-2 lightbox-trigger">
					<img src="asset/img/logo-duna-ipoly.png">
				</div>

				<div class="col-md-11 mt-2">
					<h5>Duna-Ipoly Nemzeti Park</h5>
					<p>Ez a legközelebb eső nemzeti park Budapesthez, igazgatósága innen irányítja működését. A Duna-Ipoly Nemzeti Park völgyek, hegyek és egy síkság is találkozik, így igen változatás élettérrel szolgál. Sok növény és állatfaj található meg itt és sehol máshol az országban, amik megmentésére számos program indult.</p>
					<a class="continue" href="DunaIpoly.php">Tovább az oldalra<p class="arrowselect right"></p></a>
				</div>
			</div>
		<!--SOR 5-->
		...
		<!--SOR 6-->
			...
			<div class="row wow fadeInUp" data-wow-delay="0.2s">
				<div class="col-md-1 mt-2 lightbox-trigger">
					<img src="asset/img/logo-ferto-hansag.png">
				</div>

				<div class="col-md-11 mt-2">
					<h5>Fertő-Hanság Nemzeti Park</h5>
					<p>A magyar-osztrák határon fekvő nemzeti park mindkét országhoz tartozik és a tájvédelmi átszervezés óta a terület közös irányítás alatt van. Ez a park is bioszféra rezervátumként van nyilván tartva és a Fertő-tó a Ramsari Egyezmény vadvizei között is helyet kapott.</p>
					<a class="continue" href="Ferto.php">Tovább az oldalra<p class="arrowselect right"></p></a>
				</div>
			</div>
		<!--SOR 6-->
		...
		<!--SOR 7-->
			...
			<div class="row wow fadeInUp" data-wow-delay="0.2s">
				<div class="col-md-1 mt-2 lightbox-trigger">
					<img src="asset/img/logo-hortobagy.png">
				</div>

				<div class="col-md-11 mt-2">
					<h5>Hortobágyi Nemzeti Park</h5>
					<p>Magyarország elsőként létrehozott nemzeti parkja a Hortobágyi Nemzeti Park, melyet 1973-ban alapítottak és 82 ezer hektáron terül el. Négy tájvédelmi körzetből áll, a Szatmár-Bereg, Közép-Tiszai, Hajdúsági és a Bihar-síki Tájvédelmi Körzet is a Hortobágyhoz tartozik.</p>
					<a class="continue" href="Hortobagyi.php">Tovább az oldalra<p class="arrowselect right"></p></a>
				</div>
			</div>
		<!--SOR 7-->
		...
		<!--SOR 8-->
			...
			<div class="row wow fadeInUp" data-wow-delay="0.2s">
				<div class="col-md-1 mt-2 lightbox-trigger">
					<img src="asset/img/logo-kiskunsag.png">
				</div>

				<div class="col-md-11 mt-2">
					<h5>Kiskunsági Nemzeti Park</h5>
					<p>A Nemzeti Parkot 1975-ben alapították és a környező megyeszékhelyet, Kecskemétet választották az igazgatóság székhelyének. A táj az ember és természet több százéves kapcsolatát jelképezi és a magasztos Tisza-part sok magyar költőt és festőt is megihletett.</p>
					<a class="continue" href="Kiskun.php">Tovább az oldalra<p class="arrowselect right"></p></a>
				</div>
			</div>
		<!--SOR 8-->
		...
		<!--SOR 9-->
			...
			<div class="row wow fadeInUp" data-wow-delay="0.2s">
				<div class="col-md-1 mt-2 lightbox-trigger">
					<img src="asset/img/logo-koros-maros-e1394573776774.png">
				</div>

				<div class="col-md-11 mt-2">
					<h5>Körös-Maros Nemzeti Park</h5>
					<p>A Körös-Maros Nemzeti Parkot 1997-ben alapították, szarvasi igazgatósággal, hogy összefogja a terület természetvédelmi kezelését. A park, két részre különíthető el: a Körös vidékre és a Békés-Csanádi löszhátra.</p>
					<a class="continue" href="Koros.php">Tovább az oldalra<p class="arrowselect right"></p></a>
				</div>
			</div>
		<!--SOR 9-->
		...
		<!--SOR 10-->
			...
			<div class="row wow fadeInUp" data-wow-delay="0.2s">
				<div class="col-md-1 mt-2 lightbox-trigger">
					<img src="asset/img/logo-orsegi-e1394574435736.png">
				</div>

				<div class="col-md-11 mt-2">
					<h5>Őrségi Nemzeti Park</h5>
					<p>Az Őrségi Nemzeti Parkot 2002-ben alapították, és Őriszentpétert választották székhelyül. A térség magába foglalja az Őrség, Rába folyó völgye, Vendvidék és a Szentgyörgyvölgy környékét is. A park egy széles dombságon terül el, amin több mint 200 forrás és 15 patak található.</p>
					<a class="continue" href="Orsegi.php">Tovább az oldalra<p class="arrowselect right"></p></a>
				</div>
			</div>
		<!--SOR 10-->
	</div>  
					...
					<!-- <div class="keret">
						...
						<div class="row wow fadeInUp" data-wow-delay="0.4s">
							<div style="margin-top: 15px">
								<div class="keret" style="height: 820px;">
