...
<head>
	...
	<title>VáltozóJövő - Duna-Ipoly Nemzeti Park</title>
							...
							<ul>
								...
								<li class="dropdown active"><a href="Területek.php">Területek</a>
									<div class="dropdown-content">
										...
										<a class="active1">Duna-Ipoly Nemzeti Park</a>
...
<!--NAVIGÁCIÓ-->
	...
	<div class="col-xl-6 keret">
		<h2 class="fst-italic py-3 px-3 text-white" style="border:2px solid black; background-color: purple">Duna-Ipoly Nemzeti Park</h2>
			
		<!--SOR 1-->
			<div class="row wow fadeInUp" data-wow-delay="0.2s">
				<div class="col-md-6 lightbox-trigger">
					<img class="img-fluid thumbnail leftimage my-3" src="asset/img/dunai1.jpg">
				</div>

				<div class="col-md-6">
					<h3 class="mb-4"><strong>Védd te is, amit ajándékba kaptunk!</strong></h3>
		...
		<!--SOR 2-->
			<div class="row wow fadeInUp" data-wow-delay="0.3s">
				<div class="col-md-6">
					<h6>Ez a legközelebb eső nemzeti park Budapesthez, igazgatósága innen irányítja működését. A Duna-Ipoly Nemzeti Park völgyek, hegyek és egy síkság is találkozik, így igen változatás élettérrel szolgál. Sok növény és állatfaj található meg itt és sehol máshol az országban, amik megmentésére számos program indult.</h6>
				</div>

				<div class="col-md-6 lightbox-trigger">
					<img class="img-fluid thumbnail rightimage" src="asset/img/dunai2.jpg">
				</div>
				<hr class="my-4">
			</div>
		<!--SOR 2-->
		...
		<!--SOR 3-->
			<div class="row wow fadeInUp" data-wow-delay="0.4s">
				<div class="col-md-6 lightbox-trigger">
					<img class="img-fluid thumbnail leftimage" src="asset/img/dunai3.jpg">
				</div>

				<div class="col-md-6 my-3">
					<h6>A Börzsöny vulkáni tevékenység során alakult ki, legmagasabb pontja 938 méterre rúg. Több mint 300 forrása van, melyek a környező patakokat duzzasztják. A Dunakanyar túraútvonala közel 8 km hosszú, ami érinti a Sas-hegyet, a Kopasz-hegyet, a Bezina-völgyi erdőt és a Nagybörzsönyi kisvasutat is.
						A Pilis szintén közkedvelt kirándulópont, főleg a budapestiek számára. Itt található a Rám-szakadék, Magyarország legszebb és legnehezebben járható turistaútvonala.
					</h6>
				</div>
				<hr class="my-4">
			</div>
		...
		<!--SOR 4-->
			<div class="row wow fadeInUp" data-wow-delay="0.5s">
				<div class="col-md-6">
					<h6>A Pilis szintén közkedvelt kirándulópont, főleg a budapestiek számára. Itt található a Rám-szakadék, Magyarország legszebb és legnehezebben járható turistaútvonala. A vonulat 7 km hosszú túrát jelent a szurdokvölgyben, ami alatt megfigyelhetjük a vulkáni rétegek keresztmetszetét. </h6>
					<h6>A Visegrádi hegység, az Északi-középhegység legnyugatibb tája, a Börzsönyhöz hasonló kőzetrétegből alakult ki. Az legnevezetesebb kilátója Dobogókő, ami 700 méteres, és gyalog és biciklivel is megközelíthető.</h6>
				</div>

				<div class="col-md-6 lightbox-trigger">
					<img class="img-fluid thumbnail rightimage" src="asset/img/dunai5.jpg">
				</div>
				<hr class="my-4">
			</div>
		<!--SOR 4-->
				...
				<div class="container-fluid">
					<div class="row justify-content-center align-items-center">
					  <div class="col-12">
						...
						<h4 class="text-center">Nagybörzsönyi Ifjúsági Tábor</h4>
						<img src="asset/img/Dunaimap.png" alt="Dunaimap" class="img-fluid keret">
					  </div>
					</div>
					<div class="col-md-12">
					...
					<div class="keret">
						...
						<div class="row wow fadeInUp" data-wow-delay="0.4s">
							...
							<h4 class="fst-italic py-3 px-3 text-white text-center" style="border:2px solid black; background-color: purple">Jelenlegi adatok</h4>
									<button id="showTable11Btn" onclick="showTable(11)" class="my-button">Állatok</button>
									<button id="hideTable11Btn" onclick="hideTable(11)" class="my-button" style="display: none;">Bezár</button>
									<button id="showTable12Btn" onclick="showTable(12)" class="my-button">Növények</button>		
									<button id="hideTable12Btn" onclick="hideTable(12)" class="my-button" style="display: none;">Bezár</button>
								</div>
							</div>
						</div>
					</div>
