...
<head>
	...
	<title>VáltozóJövő - Kőrös-Maros Nemzeti Park</title>
							...
							<ul>
								...
								<li class="dropdown active"><a href="Területek.php">Területek</a>
									<div class="dropdown-content">
										...
										<a class="active1">Körös-Maros Nemzeti Park</a>
...
<!--NAVIGÁCIÓ-->
	...
	<div class="col-xl-6 keret">
		<h2 class="fst-italic py-3 px-3 text-white" style="border:2px solid black; background-color: purple">Körös Maros Nemzeti Park</h2>
			
		<!--SOR 1-->
			<div class="row wow fadeInUp" data-wow-delay="0.2s">
				<div class="col-md-6 lightbox-trigger">
					<img class="img-fluid thumbnail leftimage my-4" src="asset/img/koros1.jpg">
				</div>
		...
		<!--SOR 2-->
			<div class="row wow fadeInUp" data-wow-delay="0.3s">
				<div class="col-md-6">
					<h6>A Körös-Maros Nemzeti Parkot 1997-ben alapították, szarvasi igazgatósággal, hogy összefogja a terület természetvédelmi kezelését. A park, két részre különíthető el: a Körös vidékre és a Békés-Csanádi löszhátra. </h6>
					<h6>A nemzeti park folyói, a Körös és a Maros, illetve az itt található erdők a romániai hegységek lábától egészen a Tiszáig elérnek. </h6>
				</div>

				<div class="col-md-6 lightbox-trigger">
					<img class="img-fluid thumbnail rightimage" src="asset/img/koros2.jpg">
				</div>
				<hr class="my-4">
			</div>
		<!--SOR 2-->
		...
		<!--SOR 3-->
			<div class="row wow fadeInUp" data-wow-delay="0.4s">
				<div class="col-md-6 lightbox-trigger">
					<img class="img-fluid thumbnail leftimage" src="asset/img/koros3.jpeg">
				</div>

				<div class="col-md-6 my-3">
					<h6>A Biharugrai tavaknak közel 1900 hektáros lefedettsége van. A felmérések szerint közel 42 különböző halfaj található a vizekben. A tavak madárvilága roppant változatos, itt fészkel a gulipán, kékbegy és a szerecsensirály is. Magyarországon csak itt található az erdélyi hérics és a bókoló zsálya, ezért mindkét növényállomány fenntartásáért komoly tevékenységek zajlanak. </h6> 
				</div>
				<hr class="my-4">
			</div>
		<!--SOR 3-->
		...
		<!--SOR 4-->
			<div class="row wow fadeInUp" data-wow-delay="0.5s">
				<div class="col-md-6">
					<h6>A térségben sok a szikes, legelős puszta, amik nagy botanikai jelentőséggel bírnak. A nemzeti park leghíresebb és legvonzóbb természetvédelmi területe a Szarvasi Arborétum, ahova mindenképpen túravezetővel érdemes ellátogatni. </h6>
					<h6>A térség talán legszebb épülete a Szabadkígyósi Wenckheim-kastély. A kastély Ybl Miklós tervei alapján készült az 1800-as évek végén. Az épület udvarán gyönyörű franciakert lett kialakítva, ami legfőképp egy nagy szökőkútból és platánfákból áll.</h6>
				</div>

				<div class="col-md-6 lightbox-trigger">
					<img class="img-fluid thumbnail rightimage my-3" src="asset/img/koros4.jpg">
				</div>
				<hr class="my-4">
			</div>
		<!--SOR 4-->
				...
				<div class="container-fluid">
					<div class="row justify-content-center align-items-center">
					  <div class="col-12">
						...
						<h4 class="text-center">Állatparki KalandoZOO tábor - Körös-Maros Nemzeti Park</h4>
						<img src="asset/img/Korosmmap.png" alt="Korosmmap" class="img-fluid keret">
					  </div>
					</div>
						<div class="col-md-12">
					...
					<div class="keret">
						...
						<div class="row wow fadeInUp" data-wow-delay="0.4s">
							<div style="margin-top: 15px">
								<div class="keret">
									<h4 class="fst-italic py-3 px-3 text-white text-center" style="border:2px solid black; background-color: purple">Ügyfálszolgálat</h4>
						...
						<div class="row wow fadeInUp" data-wow-delay="0.4s">
							...
							<h4 class="fst-italic py-3 px-3 text-white text-center" style="border:2px solid black; background-color: purple">Jelenlegi adatok</h4>
									<button id="showTable19Btn" onclick="showTable(19)" class="my-button">Állatok</button>
									<button id="hideTable19Btn" onclick="hideTable(19)" class="my-button" style="display: none;">Bezár</button>
									<button id="showTable20Btn" onclick="showTable(20)" class="my-button">Növények</button>		
									<button id="hideTable20Btn" onclick="hideTable(20)" class="my-button" style="display: none;">Bezár</button>
								</div>
							</div>
						</div>
					</div>
