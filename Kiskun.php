...
<head>
	...
	<title>VáltozóJövő - Kiskunsági Nemzeti Park</title>
							...
							<ul>
								...
								<li class="dropdown active"><a href="Területek.php">Területek</a>
									<div class="dropdown-content">
										...
										<a class="active1" style="margin-bottom: 1.5px;">Kiskunsági Nemezeti Park</a>
...
<div class="col-xl-6 keret">
	<h2 class="fst-italic py-3 px-3 text-white" style="border:2px solid black; background-color: purple">Kiskunsági Nemzeti Park</h2>
	
	<!--SOR 1-->
		<div class="row wow fadeInUp" data-wow-delay="0.2s">
			<div class="col-md-6 lightbox-trigger">
				<img class="img-fluid thumbnail leftimage my-4" src="asset/img/kisk1.jpg">
			</div>

			<div class="col-md-6">
				<h3 class="my-5"><strong>Védd te is, amit ajándékba kaptunk!</strong></h3>
	...
	<!--SOR 2-->
		<div class="row wow fadeInUp" data-wow-delay="0.3s">
			<div class="col-md-6">
				<h6>A Nemzeti Parkot 1975-ben alapították és a környező megyeszékhelyet, Kecskemétet választották az igazgatóság székhelyének. A táj az ember és természet több százéves kapcsolatát jelképezi és a magasztos Tisza-part sok magyar költőt és festőt is megihletett. </h6>
				<h6>A 48 ezer hektárnyi területből 23 ezer bioszféra rezervátumnak van kinyilvánítva. Ez azt jelenti, hogy olyan fajok megmentésére törekszenek, melyek száma roppant megfogyatkozott az utóbbi években. </h6>
			</div>

			<div class="col-md-6 lightbox-trigger">
				<img class="img-fluid thumbnail rightimage" src="asset/img/kisk2.jpg">
			</div>
			<hr class="my-4">
		</div>
	<!--SOR 2-->
	...
	<!--SOR 3-->
		<div class="row wow fadeInUp" data-wow-delay="0.4s">
			<div class="col-md-6 lightbox-trigger">
				<img class="img-fluid thumbnail leftimage" src="asset/img/kisk3.jpg">
			</div>

			<div class="col-md-6 my-3">
				<h6>Két halastava van, a Fehér-tó és a Csaj-tó, melyek bővelkednek értékes halakban, mint a lápi póc és a réti csík, de él itt ponty, amur, csuka és süllő is. A Fehér-tó nagy hazai jelentőséggel bíró szikes tó, ami a terület mélyedéseiben alakult ki és jellegzetessége, hogy vize nátriumban gazdag és sziki életközösségeknek ad otthont. </h6>
			</div>
			<hr class="my-4">
		</div>
	<!--SOR 3-->
	...
	<!--SOR 4-->
		<div class="row wow fadeInUp" data-wow-delay="0.5s">
			<div class="col-md-6">
				<h6>A tavak  a halakon kívül rengeteg madárfajnak adnak élőhelyet, de vonuló helyként is szolgálnak. Laknak a tavaknál gólyák, szalakóták és túzokok is, de nem ritka az ugartyúk és a kék vércse sem. A parkban élő védett állatok közé tartozik még a vidra, a haris és a kuvik. </h6>
			</div>

			<div class="col-md-6 lightbox-trigger">
				<img class="img-fluid thumbnail rightimage" src="asset/img/kisk4.jpg">
			</div>
			<hr class="my-4">
		</div>
	<!--SOR 4-->
	...
	<!--SOR 5-->
		<div class="row wow fadeInUp" data-wow-delay="0.6s">
			<div class="col-md-6 lightbox-trigger">
				<img class="img-fluid thumbnail" src="asset/img/kisk6.jpg">
			</div>

			<div class="col-md-6 my-3">
				<h6>A nemzeti park egyik érdekes kirándulóhelye az Ópusztaszeri Nemzeti Történeti Emlékpark. A parkban egy egész napra elegendő látnivalóval találkozhatsz, mint például a Skanzen, a Monostor vagy az Árpád emlékmű.</h6>
			</div>
			<hr class="my-4">
		</div>
	<!--SOR 5-->
			...
			<div class="container-fluid">
				<div class="row justify-content-center align-items-center">
				  <div class="col-12">
					...
					<h4 class="text-center">Önkéntes természetvédelmi tábor</h4>
					<img src="asset/img/Kiskmap.png" alt="Kiskmap" class="img-fluid keret">
				  </div>
				</div>
					<div class="col-md-12">
					...
					<div class="keret">
						...
						<div class="row wow fadeInUp" data-wow-delay="0.4s">
							...
							<h4 class="fst-italic py-3 px-3 text-white text-center" style="border:2px solid black; background-color: purple">Jelenlegi adatok</h4>
									<button id="showTable17Btn" onclick="showTable(17)" class="my-button">Állatok</button>
									<button id="hideTable17Btn" onclick="hideTable(17)" class="my-button" style="display: none;">Bezár</button>
									<button id="showTable18Btn" onclick="showTable(18)" class="my-button">Növények</button>		
									<button id="hideTable18Btn" onclick="hideTable(18)" class="my-button" style="display: none;">Bezár</button>
								</div>
							</div>
						</div>
					</div>
