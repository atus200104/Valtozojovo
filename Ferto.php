...
<head>
	...
	<title>VáltozóJövő - Fertő Nemzeti Park</title>
							...
							<ul>
								...
								<li class="dropdown active"><a href="Területek.php">Területek</a>
									<div class="dropdown-content">
										...
										<a class="active1" style="margin-bottom: 1.5px;">Fertő-Hanság Nemzeti Park</a>
...
<div class="col-xl-6 keret">
	<h2 class="fst-italic py-3 px-3 text-white" style="border:2px solid black; background-color: purple">Fertő-Hanság Nemzeti Park</h2>
		
	<!--SOR 1-->
		<div class="row wow fadeInUp" data-wow-delay="0.2s">
			<div class="col-md-6 lightbox-trigger">
				<img class="img-fluid thumbnail leftimage my-2" src="asset/img/ferto1.jpg">
			</div>

			<div class="col-md-6">
				<h3 class="mb-5"><strong>Védd te is, amit ajándékba kaptunk!</strong></h3>
	...
	<!--SOR 2-->
		<div class="row wow fadeInUp" data-wow-delay="0.3s">
			<div class="col-md-6">
				<h6>A magyar-osztrák határon fekvő nemzeti park mindkét országhoz tartozik és a tájvédelmi átszervezés óta a terület közös irányítás alatt van. Ez a park is bioszféra rezervátumként van nyilván tartva és a Fertő-tó a Ramsari Egyezmény vadvizei között is helyet kapott. </h6>
				<h6>A hazai park igazgatósága Sarródon van 1991 óta, míg az osztrák székhely Illmicben található.</h6>
			</div>

			<div class="col-md-6 lightbox-trigger">
				<img class="img-fluid thumbnail rightimage" src="asset/img/ferto2.jpg">
			</div>
			<hr class="my-4">
		</div>
	<!--SOR 2-->
	...
	<!--SOR 3-->
		<div class="row wow fadeInUp" data-wow-delay="0.4s">
			<div class="col-md-6 lightbox-trigger">
				<img class="img-fluid thumbnail leftimage" src="asset/img/ferto3.jpg">
			</div>

			<div class="col-md-6 my-3">
				<h6>A Fertő-tó Európa legnagyobb tavai közé tartozik, sótartalma igen magas, ezért síkvidéki sóstónak számít. A történelem során többször kiszáradt, és átlagos mélysége a mai napig nem haladja meg az egy métert. A lecsapolások miatt a tó nagy része nádassá változott, amit az utóbbi években igyekeztek megállítani.
					A mocsarak és lápos vidékek jellegzetes élővilággal rendelkeznek. A nádas otthonául szolgál a kócsagoknak, bölömbikának, és a vörös gémeknek.
				</h6>
			</div>
			<hr class="my-4">
		</div>
	...
	<div class="row wow fadeInUp" data-wow-delay="0.5s">
		<div class="col-md-6">	
			<h6> A tó legnevezetesebb halfajtái a csuka, lápi póc és a garda. </h6>
			<h6>A Hanság a tótól keletre található, a Duna és a Rába között. Tőzeges, mocsaras felszíne mocsárréteket hozott létre, melyek az idők során jelentősen megrongálódtak az emberi beavatkozások miatt. A nemzeti park igazgatósága a teljes rekonstrukcióra vállalkozott, hogy a növény-és állatvilágot rendbe hozza.</h6>
		</div>
		
		<div class="col-md-6 lightbox-trigger">
			<img class="img-fluid thumbnail rightimage" src="asset/img/ferto4.jpg">
		</div>
		<hr class="my-4">
	</div>
	<!--SOR 4-->
			...
			<div class="container-fluid">
				<div class="row justify-content-center align-items-center">
				  <div class="col-12">
					...
					<h4 class="text-center">XXII. Szigetközi Természetismereti tábor</h4>
					<img src="asset/img/Fertomap.png" alt="Fertomap" class="img-fluid keret">
				  </div>
				</div>
					<div class="col-md-12">
					...
					<div class="keret">
						...
						<div class="row wow fadeInUp" data-wow-delay="0.4s">
							...
							<h4 class="fst-italic py-3 px-3 text-white text-center" style="border:2px solid black; background-color: purple">Jelenlegi adatok</h4>
									<button id="showTable13Btn" onclick="showTable(13)" class="my-button">Állatok</button>
									<button id="hideTable13Btn" onclick="hideTable(13)" class="my-button" style="display: none;">Bezár</button>
									<button id="showTable14Btn" onclick="showTable(14)" class="my-button">Növények</button>		
									<button id="hideTable14Btn" onclick="hideTable(14)" class="my-button" style="display: none;">Bezár</button>
								</div>
							</div>
						</div>
					</div>
