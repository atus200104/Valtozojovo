...
<head>
	...
	<title>VáltozóJövő - Hortobágyi Nemzeti Park</title>
							...
							<ul>
								...
								<li class="dropdown active"><a href="Területek.php">Területek</a>
									<div class="dropdown-content">
										...
										<a class="active1">Hortobágyi Nemzeti Park</a>
...
<!--TARTALOM-->
	<div class="col-xl-6 keret px-3">
		<h2 class="fst-italic py-3 px-3 text-white" style="border:2px solid black; background-color: purple">Hortobágyi Nemzeti Park</h2>
			
		<!--SOR 1-->
			<div class="row wow fadeInUp" data-wow-delay="0.2s">
				<div class="col-md-6 lightbox-trigger">
					<img class="img-fluid thumbnail leftimage my-5" src="asset/img/hortobagy1.jpg">
				</div>
		...
		<!--SOR 2-->
			<div class="row wow fadeInUp" data-wow-delay="0.3s">
				<div class="col-md-6">
					<h6>Magyarország elsőként létrehozott nemzeti parkja a Hortobágyi Nemzeti Park, melyet 1973-ban alapítottak és 82 ezer hektáron terül el. Négy tájvédelmi körzetből áll, a Szatmár-Bereg, Közép-Tiszai, Hajdúsági és a Bihar-síki Tájvédelmi Körzet is a Hortobágyhoz tartozik.</h6>
					<h6>1999 óta a Világ Természeti és Kulturális Örökségeinek listáján szerepel, a park igazgatósága Debrecenben székel.</h6>
				</div>
				
				<div class="col-md-6 lightbox-trigger">
					<img class="img-fluid thumbnail rightimage" src="asset/img/hortobagy4.jpeg">
				</div>
				<hr class="my-4">
			</div>
		<!--SOR 2-->
		...
		<!--SOR 3-->
			<div class="row wow fadeInUp" data-wow-delay="0.4s">
				<div class="col-md-6 lightbox-trigger">
					<img class="img-fluid thumbnail leftimage" src="asset/img/hortobagy5.jpg">
				</div>

				<div class="col-md-6 my-3">
					<h6>A park legnagyobb részét szikesek és löszpuszták alkotják, rövid fűvel borított sztyeppék. Számottevő területet tesznek ki még a halastavak, mocsarak, holtágak és a nádasok.
						Növényvilága elsőre kietlennek tűnhet a hosszan elterülő sztyeppek miatt, azonban őshonos itt a sóvirág, tündérrózsa, békatutaj, nagyezerjófű és a boglárka is. 
					</h6>
				</div>
				<hr class="my-4">
			</div>
		...
		<!--SOR 4-->
			<div class="row wow fadeInUp" data-wow-delay="0.5s">
				<div class="col-md-6">
					<h6>Állatvilága is igen színes, találkozhatunk parlagi sassal, túzokkal és csíkosfejű nádiposzátával is. De élnek itt még hermelinek, ürgék, menyétek és fürjek, őket azonban rejtőzködő életmódjuknak köszönhetően nehezebb észrevenni.
						A park szintén híres a haszonállatairól, tartanak itt szürke marhát, rackanyájat, mangalicát, és különböző pásztorkutyákat, például pulit és komondort.
					</h6>
				</div>
				
				<div class="col-md-6 lightbox-trigger">
					<img class="img-fluid thumbnail rightimage" src="asset/img/hortobagy6.jpg">
				</div>
				<hr class="my-4">
			</div>
		<!--SOR 4-->
				...
				<div class="container-fluid">
					<div class="row justify-content-center align-items-center">
					  <div class="col-12">
						...
						<h4 class="text-center">Családi hagyományőrző tábor</h4>
						<img src="asset/img/Hortomap.png" alt="Hortomap" class="img-fluid keret"> 
					  </div>
					</div>
						<div class="col-md-12">
					...
					<div class="keret">
						...
						<div class="row wow fadeInUp" data-wow-delay="0.4s">
							...
							<h4 class="fst-italic py-3 px-3 text-white text-center" style="border:2px solid black; background-color: purple">Jelenlegi adatok</h4>
									<button id="showTable15Btn" onclick="showTable(15)" class="my-button">Állatok</button>
									<button id="hideTable15Btn" onclick="hideTable(15)" class="my-button" style="display: none;">Bezár</button>
									<button id="showTable16Btn" onclick="showTable(16)" class="my-button">Növények</button>		
									<button id="hideTable16Btn" onclick="hideTable(16)" class="my-button" style="display: none;">Bezár</button>
								</div>
							</div>
						</div>
					</div>
