...
<head>
	...
	<title>VáltozóJövő - Duna-Dráva Nemzeti Park</title>
							...
							<ul>
								...
								<li class="dropdown active"><a href="Területek.php">Területek</a>
									<div class="dropdown-content">
										...
										<a class="active1" style="margin-bottom: 1.5px;">Duna-Dráva Nemzeti Park</a>
...
<div class="col-xl-6 keret">
	...
	<h2 class="fst-italic py-3 px-3 text-white" style="border:2px solid black; background-color: purple">Duna-Dráva Nemzeti Park</h2>
		
	<!--SOR 1-->
		<div class="row wow fadeInUp" data-wow-delay="0.2s">
			<div class="col-md-6 lightbox-trigger">
				<img class="img-fluid thumbnail leftimage my-4" src="asset/img/dunad1.jpg">
			</div>

			<div class="col-md-6">
				<h3 class="my-3"><strong>Védd te is, amit ajándékba kaptunk!</strong></h3>
	...
	<!--SOR 2-->
		<div class="row wow fadeInUp" data-wow-delay="0.3s">
			<div class="col-md-6">
				<h6>A pécsi székhellyel rendelkező nemzeti park az országhatár, a Sió-torkolat és a Dráva mentén helyezkedik el, több mint 50 ezer hektárt fed le. Legnagyobb része dombság és síkság, egyedül a Mecsek és a Villányi-hegység emelkednek ki a domborzaton. </h6>
				<h6>A nemzeti park 6 tájvédelmi egységből áll: Gemenc, Béda-Karapancsa, Dráva menti síkság, Barcsi-ősborókás, Lankóczi-erdő és a Zákány-Őrtilos térsége. </h6>
			</div>

			<div class="col-md-6 lightbox-trigger">
				<img class="img-fluid thumbnail rightimage" src="asset/img/dunad2.jpg">
			</div>
			<hr class="my-4">
		</div>
	<!--SOR 2-->
	...
	<!--SOR 3-->
		<div class="row wow fadeInUp" data-wow-delay="0.4s">
			<div class="col-md-6 lightbox-trigger">
				<img class="img-fluid thumbnail leftimage" src="asset/img/dunad4.jpg">
			</div>

			<div class="col-md-6 my-3">
				<h6>Gemenc már 1977 óta védett terület, mint az ország legnagyobb erdővel borított ártere. Az állandó víz miatt füzek, nyárfák, galagonya és szeder talált itt élőhelyet magának. Szürke gémek, békászó sasok és több nagyvad is otthonra talál az erdőkben, mint például gímszarvasok, őzek és vaddisznók. </h6>
			</div>
			<hr class="my-4">
		</div>
	<!--SOR 3-->
	...
	<!--SOR 4-->
		<div class="row wow fadeInUp" data-wow-delay="0.5s">
			<div class="col-md-6">
				<h6>Béda-Karapancsa térségében az egyik legnépszerűbb látnivaló Mohács és a Mohácsi-sziget. Holtágaktól, úgynevezett morotváktól hemzseg, így sok rész elmocsarasodott. A legtöbb részt azonban itt is erdő fedi, amit az intenzív erdőgazdálkodás nagyban befolyásol.</h6>
			</div>

			<div class="col-md-6 lightbox-trigger">
				<img class="img-fluid thumbnail rightimage" src="asset/img/dunad5.jpg">
			</div>
			<hr class="my-4">
		</div>
	<!--SOR 4-->
	...
	<!--SOR 5-->
		<div class="row wow fadeInUp" data-wow-delay="0.6s">
			<div class="col-md-6 lightbox-trigger">
				<img class="img-fluid thumbnail leftimage" src="asset/img/dunad6.jpg">
			</div>

			<div class="col-md-6 my-5">
				<h6>A Dráva menti síkságon akár 15 km hosszú holtágak is lehetnek. A térség látnivalói közé tartozik a Mattyi Madár Emlékpark, ami a magyar ökoszisztémában kipusztult madárfajoknak állít emléket.</h6>
			</div>
			<hr class="my-4">
		</div>
	<!--SOR 5-->
			...
			<div class="container-fluid">
				<div class="row justify-content-center align-items-center">
				  <div class="col-12">
					...
					<h4 class="text-center">Béda tábor</h4>
					<img src="asset/img/Dunadmap.png" alt="Dunadmap" class="img-fluid keret">
				  </div>
				</div>
					<div class="col-md-12">
					...
					<div class="keret">
						...
						<div class="row wow fadeInUp" data-wow-delay="0.4s">
							...
							<h4 class="fst-italic py-3 px-3 text-white text-center" style="border:2px solid black; background-color: purple">Jelenlegi adatok</h4>
									<button id="showTable9Btn" onclick="showTable(9)" class="my-button">Állatok</button>
									<button id="hideTable9Btn" onclick="hideTable(9)" class="my-button" style="display: none;">Bezár</button>
									<button id="showTable10Btn" onclick="showTable(10)" class="my-button">Növények</button>		
									<button id="hideTable10Btn" onclick="hideTable(10)" class="my-button" style="display: none;">Bezár</button>
								</div>
							</div>
						</div>
					</div>
		...
		<div class="column details">
			<div class="signin">
				...
				<form action="login.php" method="POST" class="text-center">
					...
					<input type="password" placeholder="Jelszó" name="password" class="margin" pattern="^[a-zA-Z0-9._%+-]+@(gmail|yahoo|hotmail|outlook|live|aol)\.(com|com\.[a-zA-Z]{2}|co\.uk)$" required>
