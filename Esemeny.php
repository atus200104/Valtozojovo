...
<head>
	...
	<title>VáltozóJövő - Események</title>
				...
				<div class="keret position-sticky">
					...
					<div class="oldalnav">
						<ul>
							...
							<li class="active">Eddigi események</li>
...
<!--NAVIGÁCIÓ-->
	...
	<div class="col-xl-6 keret">
		<h2 class="fst-italic py-3 px-3 text-white" style="border:2px solid black; background-color: purple">Túrázási emlékek!</h2>
			
		<!--SOR 1-->
			<div class="row wow fadeInUp" data-wow-delay="0.2s">
				<div class="col-md-7 mt-2 lightbox-trigger">
					<img class="img-fluid thumbnail leftimage" src="asset/img/Aggtelekitura.jpg">
				</div>

				<div class="col-md-5 mt-5">
					<h5>Aggteteli Nemzeti Park</h5>
					<p>Március a barlangok hónapja, így mi sem hagyhattuk ki az Aggteleki cseppkőbarlangot.</p>
				</div>
			</div>
		<!--SOR 1-->
		...
		<!--SOR 2-->
			...
			<div class="row wow fadeInUp" data-wow-delay="0.2s">
				<div class="col-md-7 mt-2 lightbox-trigger">
					<img class="img-fluid thumbnail leftimage" src="asset/img/Balatonfelvtura.jpg">
				</div>

				<div class="col-md-5 mt-5">
					<h5>Balaton-felvidéki Nemzeti Park</h5>
					<p>Lenyügöző látványban volt részünk a Balaton-felvidéki Nemzeti Parkban.</p>
				</div>
			</div>
		<!--SOR 2-->
		...
		<!--SOR 3-->
			...
			<div class="row wow fadeInUp" data-wow-delay="0.2s">
				<div class="col-md-7 mt-2 lightbox-trigger">
					<img class="img-fluid thumbnail leftimage" src="asset/img/bukkitura.jpg">
				</div>

				<div class="col-md-5 mt-5">
					<h5>Bükki Nemzeti Park</h5>
					<p>Káprázatos sétány a Bükki Nemzeti Parkban.</p>
				</div>
			</div>
		<!--SOR 3-->
		...
		<!--SOR 4-->
			...
			<div class="row wow fadeInUp" data-wow-delay="0.2s">
				<div class="col-md-7 mt-2 lightbox-trigger">
					<img class="img-fluid thumbnail leftimage" src="asset/img/Duna-drava kenu.jpg">
				</div>

				<div class="col-md-5 mt-5">
					<h5>Duna-Dráva Nemzeti Park</h5>
					<p>Kenuzás a Duna-Dráva mentén.</p>
				</div>
			</div>
		<!--SOR 4-->
		...
		<!--SOR 5-->
			...
			<div class="row wow fadeInUp" data-wow-delay="0.2s">
				<div class="col-md-7 mt-2 lightbox-trigger">
					<img class="img-fluid thumbnail leftimage" src="asset/img/Duna_ipoly turazas.jpg">
				</div>

				<div class="col-md-5 mt-5">
					<h5>Duna-Ipoly Nemzeti Park</h5>
					<p>Remek nap egy remek helyen.</p>
				</div>
			</div>
		<!--SOR 5-->
		...
		<!--SOR 6-->
			...
			<div class="row wow fadeInUp" data-wow-delay="0.2s">
				<div class="col-md-7 mt-2 lightbox-trigger">
				<img class="img-fluid thumbnail leftimage" src="asset/img/ferto tura.jpg">
				</div>

				<div class="col-md-5 mt-5">
					<h5>Fertő-Hanság Nemzeti Park</h5>
					<p>Hajókázás a Fertő-tavon</p>
				</div>
			</div>
		<!--SOR 6-->
		...
		<!--SOR 7-->
			...
			<div class="row wow fadeInUp" data-wow-delay="0.2s">
				<div class="col-md-7 mt-2 lightbox-trigger">
					<img class="img-fluid thumbnail leftimage" src="asset/img/Lovastura.jpg">
				</div>

				<div class="col-md-5 mt-5">
					<h5>Hortobágyi Nemzeti Park</h5>
					<p>Lovastúra a Hortobágyi Nemzeti Parkban..</p>
				</div>
			</div>
		<!--SOR 7-->
		...
		<!--SOR 8-->
			...
			<div class="row wow fadeInUp" data-wow-delay="0.2s">
				<div class="col-md-7 mt-2 lightbox-trigger">
					<img class="img-fluid thumbnail leftimage" src="asset/img/Kiskunsaglovas.jpg">
				</div>

				<div class="col-md-5 mt-5">
					<h5>Kiskunsági Nemzeti Park</h5>
					<p>Lovastúra a Kiskunsági Nemzeti Parkban..</p>
				</div>
			</div>
		<!--SOR 8-->
		...
		<!--SOR 9-->
			...
			<div class="row wow fadeInUp" data-wow-delay="0.2s">
				<div class="col-md-7 mt-2 lightbox-trigger">
					<img class="img-fluid thumbnail leftimage" src="asset/img/Koroskenu.jpg">
				</div>

				<div class="col-md-5 mt-5">
					<h5>Körös-Maros Nemzeti Park</h5>
					<p>Kenuzás a Körös mentén.</p>
				</div>
			</div>
		<!--SOR 9-->
		...
		<!--SOR 10-->
			...
			<div class="row wow fadeInUp" data-wow-delay="0.2s">
				<div class="col-md-7 mt-2 lightbox-trigger">
					<img class="img-fluid thumbnail leftimage" src="asset/img/Orsegitura.jpg">
				</div>

				<div class="col-md-5 mt-5">
					<h5>Őrségi Nemzeti Park</h5>
					<p>Gyalogos túrázás az Őrségi Nemzeti Parkban.</p>
				</div>
			</div>
		<!--SOR 10-->
	</div>  
